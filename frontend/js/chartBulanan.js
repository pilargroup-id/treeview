...
function renderChart() {
    ...
    // Konfigurasi untuk bar chart yang lebih rapat
    const barConfig = {
        type: 'bar',
        yAxisID: 'y',
        barPercentage: 0.8, // Diperbesar dari 0.9
        categoryPercentage: 0.6, // Diperkecil dari 0.8 untuk lebih rapat
        borderSkipped: false,
        borderRadius: 4,
        borderWidth: 1
    };
    ...
    // Opsi chart dengan pengaturan grouping
    const scales = {
        y: {
            beginAtZero: true,
            position: 'left',
