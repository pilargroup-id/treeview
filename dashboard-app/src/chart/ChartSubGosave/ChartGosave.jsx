...
import YearsCardGosave from './yearsCardGosave';
...
const SubBusinessUnitDropdown = React.memo(({ value, options = [], onChange }) => {
  ...
  const subBusinessUnitLabel = 'Gosave Channel';
    ...
    if (filterType === 'range' && rangeDates.length > 0) {
      ...
      if (parsedRange) {
        ...
        return {
          ...parsedRange,
          dateType: 'range',
          channels: normalizedSubBusinessUnit ? [normalizedSubBusinessUnit] : []
        };
      }
    }
